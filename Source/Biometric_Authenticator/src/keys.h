...
char kkfile[50];	//reads the verified password
int q = 0;		//control flag
void kkwebpage();	// upload function decaration
...
void makepss()
    ...
    while (kkc != 7)		// Counts 7 button presses
	{
	sleep(1);
	if (b1() != 0)
	    {
	    kkc++;		//counts if b1 is pressed
