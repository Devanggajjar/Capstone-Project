...
int enroll_start() {
	...
	sprintf(ENROLL_ST_ACK, "%02X", recieve[8]);
	return atof(ENROLL_ST_ACK);		// returns the acknowledgment
}
...
int trial_1() {
	...
	sleep(1);
	read(mainfd, (void*) &recieve, 48);  //reads the acknowledgment
	sprintf(ENROLL_1_ACK, "%02X", recieve[8]);
	return atof(ENROLL_1_ACK);				// returns the acknowledgment
}
...
int trial_2() {
	...
	sleep(1);
	read(mainfd, (void*) &recieve, 48); //reads the acknowledgment
	sprintf(ENROLL_2_ACK, "%02X", recieve[8]);
	return atof(ENROLL_2_ACK);			// returns the acknowledgment
}
...
int finalize() {
	...
	sleep(1);
	read(mainfd, (void*) &recieve, 48); 	//reads the acknowledgment
	sprintf(ENROLL_3_ACK, "%02X", recieve[8]);
	return atof(ENROLL_3_ACK);				// returns the acknowledgment
}
...
int ispress() {
	...
	sleep(1);
	read(mainfd, (void*) &recieve, 48); 	//read the acknowledgment
	sprintf(IS_PRESS_ACK, "%02X", recieve[10]);
	return atof(IS_PRESS_ACK);				//returns the acknowledgment
}
